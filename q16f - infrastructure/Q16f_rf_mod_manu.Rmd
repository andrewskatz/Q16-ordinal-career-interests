---
title: "Question 16f - Resilient Infrastructure - infra"
author: "Katz et al."
date: "5/22/2021"
...
file_name <- paste(analysis_item,
                   ...
                   sep = "_")
# ggsave(
#   filename = "Q16f_infra_halfeye_Qs_20220930.png",
#   plot = param_plot_q,
#   width = 7,
#   height = 5,
#   units = "in",
...
p <- var_imp_df %>%
  ...
  mutate(variable = case_when(variable == "Q4p" ~ "Career sat.: Volunteering",
                              ...
                              variable == "Q16f" ~ "Career: Resilient Infrastructure",
                              ...
                              variable == "Q16f" ~ "Career: Work on Resilient Infrastructure",
