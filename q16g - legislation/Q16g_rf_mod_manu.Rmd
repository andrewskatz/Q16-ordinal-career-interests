---
title: "Question 16g - Climate Change Legislation - legisla"
author: "Katz et al."
date: "11/08/2022"
...
file_name <- paste(analysis_item,
                   ...
                   sep = "_")
# ggsave(
#   filename = "Q16g_legisla_halfeye_Qs_20220930.png",
#   plot = param_plot_q,
#   width = 7,
#   height = 5,
#   units = "in",
...
p <- var_imp_df %>%
  ...
  mutate(variable = case_when(variable == "Q4p" ~ "Career sat.: Volunteering",
                              ...
                              variable == "Q16g" ~ "Career: Climate Change Legislation",
                              ...
                              variable == "Q16g" ~ "Career: Work on Climate Change Legislation",
